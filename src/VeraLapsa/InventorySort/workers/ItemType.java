...
public enum ItemType
{
    ...
    BED( 26, "Bed", "bed" ),
    POWEREDRAIL( 27, "Powered Rail", new String[]{"poweredrail", "prail"}),
    DETECTORRAIL( 28, "Detector Rail", new String[]{"detectorrail", "drail"}),
	COBWEB( 30, "Cobweb", new String[]{	"cobweb", "web"}),
	TALLGRASS( 31, "Tall Grass", "tallgrass"),
	DEADSHRUBS( 32, "Dead Shrubs", new String[]{"deadshrubs","deadshrub","dshrub"}),
    ...
    MOSSY_COBBLESTONE( 48, "Cobblestone (mossy)", new String[]{"mossycobblestone", "mossstone", "mossystone","mosscobble", "mossycobble", "moss", "mossy"} ),
    ...
    REDSTONE_TORCH_OFF( 75, "Redstone torch (off)", new String[]{"redstonetorch", " redstonetorchoff", "rstorch"} ),
	...
	LOCKED_CHEST(95, "Locked Chest", "lockedchest"),
	TRAPDOOR(96, "Trapdoor", new String[]{"trapdoor", "hatch"}),
